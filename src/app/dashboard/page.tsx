...
import { Activity, LayoutDashboard, Target, Crosshair, LogOut, Clock, ArrowUpRight, ArrowDownRight, Zap } from "lucide-react";
...
export default function DashboardPage() {
  return (
    <div className="flex h-screen bg-[#050B14] text-white font-sans overflow-hidden">
      ...
      {/* Sidebar */}
      <aside className="w-64 border-r border-[#1E293B] bg-[#0A1220]/50 backdrop-blur-md hidden md:flex flex-col">
        ...
        <nav className="flex-1 p-4 space-y-2">
          ...
          <Link href="/dashboard/results" className="flex items-center gap-3 px-4 py-3 rounded-xl text-[#94A3B8] hover:bg-[#1E293B]/50 hover:text-white transition-colors font-medium">
      ...
      <main className="flex-1 flex flex-col h-full overflow-hidden">
        ...
        <header className="md:hidden p-4 border-b border-[#1E293B] bg-[#0A1220]/80 backdrop-blur-md flex items-center justify-between">
          ...
          <Link href="/" className="text-sm font-medium text-[#94A3B8] hover:text-white">Home</Link>
        </header>
